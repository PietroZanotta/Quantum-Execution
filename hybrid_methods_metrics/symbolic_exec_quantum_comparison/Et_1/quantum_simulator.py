...
# c_file = os.path.join(script_dir, "Et1_true_unrolled_2.c")
# c_file = os.path.join(script_dir, "Et1_true_unrolled_4.c")
c_file = os.path.join(script_dir, "Et1_true_unrolled_8.c")
