...
# c_file = os.path.join(script_dir, "fibonacci_unrolled_2.c")
# c_file = os.path.join(script_dir, "fibonacci_unrolled_4.c")
c_file = os.path.join(script_dir, "fibonacci_unrolled_8.c")
