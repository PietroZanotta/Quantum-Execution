...
c_file = os.path.join(script_dir, "num_digits_bin_unrolled_1.c")
c_file = os.path.join(script_dir, "num_digits_bin_unrolled_2.c")
c_file = os.path.join(script_dir, "num_digits_bin_unrolled_4.c")
